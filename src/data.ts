...
export const TEAM_DATA: TeamMember[] = [
  {
    id: "t1",
    name: "Nitin Swami",
    nameHindi: "नितिन स्वामी",
    role: "President",
    roleHindi: "अध्यक्ष",
    imageUrl: nitinSwamiPhoto,
    bio: "युवा प्रणेता एवं सामाजिक नेतृत्वकर्ता, पश्चिमांचल विकास परिषद (भारत) के अध्यक्ष, जो क्षेत्र को प्रदूषण, जल संकट व कैंसर जैसी घातक बीमारियों से बचाने के महासंकल्प के साथ कार्यरत हैं।",
    socials: {
      twitter: "#",
      facebook: "#",
      linkedin: "#"
